...
# Plots tilt angles for the (0,0) column only: body_id 0 (iz=0), 4 (iz=1), 8 (iz=2).
...
# ---------------------------------------------------------------------------
# Column (0,0) body IDs and subplot titles
# ---------------------------------------------------------------------------
_COLUMN_00_BODY_IDS: List[int] = [0, 4, 8]

_OCT_TITLES: Dict[int, str] = {
    0: "Octahedron (0,0,0) \u2014 bottom",
    4: "Octahedron (0,0,1) \u2014 middle",
    8: "Octahedron (0,0,2) \u2014 top",
}
