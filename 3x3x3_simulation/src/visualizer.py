...
# Reads body positions/quaternions from a CSV, builds octahedra and spheres for the 3x3x3 grid.
...
# Color palette for up to 27 octahedra, cycling by Z-layer (9 per layer)
